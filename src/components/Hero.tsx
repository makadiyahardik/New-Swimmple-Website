        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 relative animate-fade-in-up" style={{animationDelay: '0.6s'}}>
            <div className="relative mx-auto max-w-md lg:max-w-full">
              ...
              <img 
                src="https://images.unsplash.com/photo-1519861531473-9200262188bf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8c3dpbW1lcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60" 
